...
The currency converter implements a robust three-tier fallback system. For detailed architecture information, see [currency-architecture.md](currency-architecture.md).
...
Currency conversion does **not** work with the home screen search bar's instant conversion feature. For detailed explanation of why this is an intentional design decision, see [currency-architecture.md](currency-architecture.md#search-bar-integration).
