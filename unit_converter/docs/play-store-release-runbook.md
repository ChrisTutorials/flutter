...
- Raw screenshot regeneration through `test/integration/store_screenshots_generation_test.dart`
...
2. Regenerate raw store screenshots, process them, validate them, and sync metadata images:
...
- `fastlane generate_screenshots` - Regenerate raw screenshots, process them, and sync Play metadata
