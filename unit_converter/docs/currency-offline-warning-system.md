...
The currency converter implements a robust three-tier fallback system. For detailed architecture information, see [currency-architecture.md](currency-architecture.md#three-tier-fallback-system).
...
3. `../docs/currency-converter-tests.md`
