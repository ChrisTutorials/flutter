...
- [play-store-release-runbook.md](play-store-release-runbook.md) - Complete deployment guide
...
- For build performance issues, see [android-build-optimization.md](android-build-optimization.md)
...
For detailed information about build optimizations, see [android-build-optimization.md](android-build-optimization.md).
